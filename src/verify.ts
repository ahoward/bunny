...
export async function main(argv: string[]): Promise<number> {
  ...
  if (mode === "behavioral") {
    ...
    instructions = [
      ...
      "## BEHAVIORAL PREMISES",
      "",
      "State what the feature spec requires. One premise per behavior.",
      "",
      "```",
      "B1: Spec requires [behavior] — source: [section/requirement ID]",
      "B2: Spec requires [behavior] — source: [section/requirement ID]",
      "...",
      "```",
      "",
      "## COVERAGE TRACE",
      "",
      "For each behavioral premise, trace to SPEC.md and tests:",
      "",
      "```",
      "PREMISE: B[N]",
      "  IN SPEC.md: [yes — quote the line / no — missing]",
      "  IN TESTS:   [yes — cite test name / no — untested]",
      "  IN REVIEW:  [yes — matches delta / no — not mentioned]",
      "  STATUS:     [COVERED / GAP]",
      "```",
      "",
      "## CONSISTENCY CHECK",
      "",
      "```",
      "REDUNDANCY: Are any SPEC.md entries duplicates? [list or none]",
      "CONTRADICTION: Do any SPEC.md entries conflict? [list or none]",
      "AMBIGUITY: Could any SPEC.md entries be read two ways? [list or none]",
      "```",
      "",
      "## FINDINGS",
      "",
      "For each gap or inconsistency discovered above:",
      "",
      "### Finding [N]: [title]",
      "",
      "- **Issue**: What behavioral gap or inconsistency was found",
      "- **Severity**: critical / high / medium / low",
      "- **Evidence**: Which premise/trace exposed this (e.g., B3 IN TESTS: missing)",
      ...
      "Behaviors traced: [N]",
      "Covered: [N]  Gaps: [N]",
      "Spec is [COMPLETE/INCOMPLETE] because [evidence]",
      "```",
      "",
    ...
    instructions = [
      ...
      "",
      "You MUST use the semi-formal reasoning structure below. Fill in every section.",
      "Cite specific file:line references from the source code. Do NOT guess or assume.",
      "",
      "## FUNCTION TRACE TABLE",
      "",
      "List every public function/method in the implementation.",
      "",
      "| Function | File:Line | Behavior (VERIFIED by reading code) | Tested? |",
      "|----------|-----------|-------------------------------------|---------|",
      "| func_name | src/file.ts:42 | does X when given Y | yes — test_name / NO |",
      "",
      "## DATA FLOW ANALYSIS",
      "",
      "For each key variable or data structure:",
      "",
      "```",
      "Variable: [name]",
      "  Created at:  [file:line]",
      "  Modified at: [file:line(s)]",
      "  Consumed at: [file:line(s)]",
      "  Validated:   [yes — where / NO — unvalidated input]",
      "```",
      "",
      "## DIVERGENCE ANALYSIS",
      "",
      "Compare spec intent vs actual implementation behavior:",
      "",
      "```",
      "CLAIM D[N]: At [file:line], [code] produces [behavior]",
      "  SPEC SAYS:   [what the spec requires]",
      "  MATCH:       [MATCHES / DIVERGES]",
      "  EVIDENCE:    [execution trace or code path proving this]",
      "  CONFIDENCE:  [high/medium/low]",
      "```",
      "",
      "## UNTESTED CODE PATHS",
      "",
      "For each code branch not exercised by any test:",
      "",
      "```",
      "PATH U[N]: [file:line] — [condition] branch",
      "  WHY UNTESTED: [no test exercises this condition]",
      "  RISK:         [what bug could hide here]",
      "```",
      "",
      "## ALTERNATIVE HYPOTHESIS CHECK",
      "",
      "Ask: \"What evidence would prove this implementation IS fully correct?\"",
      "",
      "```",
      "Evidence FOR correctness:  [list what's working]",
      "Evidence AGAINST:          [list gaps from above]",
      "Verdict:                   [SOUND / HAS GAPS]",
      "```",
      "",
      "## FINDINGS",
      "",
      "Ranked by severity. Each must cite evidence from the analysis above.",
      "",
      "### Finding [N]: [title]",
      "",
      "- **Issue**: What was missed",
      "- **Severity**: critical / high / medium / low",
      "- **Evidence**: [cite D[N], U[N], or trace table row]",
      "- **Suggested Test**: A concrete test case that would catch this",
      "",
      "## CONCLUSION",
      "",
      "```",
      "Functions traced: [N]  Tested: [N]  Untested: [N]",
      "Divergences found: [N]  Untested paths: [N]",
      "Missing test coverage: [list specific areas]",
      "```",
      "",
