...
// add dependency checks here as they're introduced.
//
...
export async function handler(_params: Params, _emit?: Emit): Promise<Result> {
  ...
  // TODO: add dependency checks as they're introduced
  // e.g. database connectivity, external service reachability
