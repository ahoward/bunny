...
bny/              dark factory CLI source + project state
  roadmap.md      what to work on next
  guardrails.md   agent constraints (blast radius, protected files)
...
.bny/             runtime state (gitignored — brane, children, proposals)
