...
1. **POD only** — plain old data, no classes for data containers
...
6. **Tests first** — design tests, then implement

## Naming

| Thing | Style | Example |
|-------|-------|---------|
| Constants | SCREAMING_SNAKE | `DB_PATH` |
| Types | PascalCase | `Bookmark` |
| Variables/functions | snake_case | `save_bookmark` |
